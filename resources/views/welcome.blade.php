...
@section('seo_principal')
    <meta name="description"
        content="En Mansion de Cristo encontrarás noticias, enseñanzas y testimonios que te ayudarán en tu crecimiento espiritual">
@endsection

@section('main')
    <div class="mx-auto container pb-5">
        <section class="bg-white dark:bg-gray-900">
            <div class="grid  px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 grid-cols-12 lg:pt-14">
                <div class="hidden lg:block mr-auto place-self-center md:col-span-6">
                    ...
                    <p
                        ...
                        ➡️Iglesia Cristiana Evangélica🛐 <br>
                        ➡️Ganamos almas a través de la Visión Celular🏠🍇<br>
                        ➡️Desde 1984 en Ciudad Guayana🏙️🇻🇪<br>
                    </p> 
                    <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">
                        <a href="https://instagram.com/mansiondecristo"
                        ...
                        <a href="https://www.facebook.com/somosmansiondecristo"
                            ...
                            @foreach ($announces as $post)
                                @if ($loop->first)
                                    <div class="swiper-slide ">
                                        <article
                                            class="transition duration-300 hover:opacity-80 rounded-lg shadow w-full h-96 bg-cover bg-center "
                                            style="background-image: url(@if ($post->image) {{ imagenes_storage($post->image->url) }}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif)">
                                            <div class="w-full h-full px-8 flex flex-col justify-center ">
        ...
        <div class="container  mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="w-full xl:w-3/5 p-12 overflow-hidden">
                <img class="rounded-lg mx-auto w-full md:w-4/5 transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6"
                    ...
                    alt="https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg" />
            </div>
