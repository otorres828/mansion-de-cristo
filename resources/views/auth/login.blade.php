        ...
        <x-jet-authentication-card >
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="pb-1">
                    ...
                    <x-jet-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')"  autofocus  placeholder="Escriba su correo" required />
                </div>
    
                <div class="mt-4">
                    <x-jet-label for="password" value="{{ __('Clave') }}" class="pb-2" />
                    <x-jet-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" placeholder="Esciba su clave" />
                </div>
