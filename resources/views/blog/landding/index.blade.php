                        ...
                        <div class="p-4 bg-white rounded-md shadow-md">
                            <ul class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-800">
                                ...
                                <li class="flex space-x-2 sm:space-x-4">
                                    ...
                                    <p class="leading-snug">
                                        Aprenderás a construir un SPA con Vue Router
                                    </p>
                                </li>
                                <li class="flex space-x-2 sm:space-x-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <p class="leading-snug">
                                        Aprenderás sobre patrón de gestion de estado (VueX)
                                    </p>
                                </li>
                                <li class="flex space-x-2 sm:space-x-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <p class="leading-snug">
                                        Aprenderás a hacer peticiones a una API con de Axios
                                    </p>
                                </li>
                                <li class="flex space-x-2 sm:space-x-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <p class="leading-snug">
                                        Aprenderás a realizar autenticaciónes
                                    </p>
                                </li>
                                <li class="flex space-x-2 sm:space-x-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    <p class="leading-snug">
                                        Aprenderás a integrar Vue con Laravel con el stack Inertia
                                    </p>
                                </li>
                            </ul>
                        </div>
