...
@section('main')
    <div class="bg-white font-sans leading-normal tracking-normal">
            ...
            <div class="bg-white">
                <div class="flex flex-wrap items-center content-center">
                    ...
                    <div class="flex w-1/2 justify-end content-center">		
                        <p class="hidden sm:block mr-3 text-center h-14 p-4 text-xs"><span class="pr-2">Comparte esto</span> 👉</p>
                            <a class="inline-block text-white no-underline hover:text-white hover:text-underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4" href="https://twitter.com/intent/tweet?url={{route('blog.show_teaching',$teaching->slug)}}" style="background-color:#33b1ff;">
                            ...
                            <a class="inline-block text-white no-underline hover:text-white hover:text-underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4" href="https://www.facebook.com/sharer/sharer.php?u={{route('blog.show_teaching',$teaching->slug)}}" style="background-color:#005e99">
        ...
        <div class="max-w-6xl mx-auto bg-cover mt-8 rounded" style="background-image:url('@if($teaching->image){{asset('storage/'.$teaching->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif');min-height: 100vh;"></div>
        ...
        <div class="container max-w-5xl mx-auto -mt-32">
            <div class="mx-0 sm:mx-6">
                <div class="bg-white w-full p-8 md:p-24 text-xl md:text-2xl text-gray-800 leading-normal" style="font-family:Georgia,serif;">
                    ...
                    <blockquote class="pt-4 border-l-4 border-green-500 italic my-8 pl-8 md:pl-12"><strong>Autor: </strong>{{$teaching->user->name}}</blockquote>
                ...
                <form action="#" >
                    <div class="container font-sans bg-green-100 rounded p-4 md:p-24 text-center mx-auto">
                        ...
                        <h3 class="font-bold break-normal  text-gray-600 text-base md:text-xl">Se el primero en obtener las ultimas enseñanzas de MDC</h3>
                ...
                <div class="flex w-full items-center font-sans p-8 md:p-24">
                    <img class="w-10 h-10 rounded-full mr-4" src="@if($teaching->image){{asset('storage/'.$teaching->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif" alt="Avatar of Author">
                    <div class="flex-1">
                        <p class="text-base font-bold md:text-xl lg:text-3xl leading-none">VER MAS ENSEÑANZAS</p>
                        <p class="text-gray-600 text-xs md:text-base">Si necesitas, no dudes en contactarnos a <a class="text-gray-800 hover:text-green-500 no-underline border-b-2 border-green-500" href="{{route('landding.index')}}">olivertorres1997@gmail.com.com</a></p>
                    </div>
                    <div class="justify-end">
                        <a href="{{route('blog.teaching')}}" class="bg-transparent border border-gray-500 hover:border-green-500 text-xs text-gray-500 hover:text-green-500 font-bold py-2 px-4 rounded-full">Leer Mas</a>
                    </div>
                </div>
            </div>  
        </div>
        ...
        <div class="bg-gray-200"> 
            ...
            <div class="grid grid-flow-row  container w-full max-w-6xl mx-auto px-2 py-8">
                <div class="grid  sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-6 snap-x">
                    ...
                    <div class="snap-center pt-4 grid-cols-2 shadow mt-5 text-sm relative max-w-64 border-0  rounded-lg break-words text-gray-800 flex flex-col" style="background-color:white;">
                        <div class="py-0 z-10 mx-6 -mt-8 rounded-lg relative">
                            <a href="{{route('blog.show_teaching',$teaching->slug)}}" class="block bg-transparent leading-none m-0 p-0 z-20 relative"><!----> 
                                <img class="rounded-lg shadow" src="@if($teaching->image){{asset('storage/'.$teaching->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif" alt="Card image cap">
                            </a> 
                        ...
                        <div class=" mt-0 px-6  flex flex-wrap items-baseline "> 
                            ...
                            <div  wire:click="filtro({{$teaching->category_id}})" class="mt-2 p-1 w-auto rounded text-xs   shadow-lg  uppercase font-serif text-white bg-green-800">
                        ...
                        <div class="py-2 px-6 ">
                            <div class="flex-grow items-center  justify-between ">
                                <h1 class="mb-3 text-gray-600 ">{{Illuminate\Support\Str::limit($teaching->extract,120,'...')}}</h1>
                            </div>
                        </div>
                        <div class="lg:hidden px-6 pb-2">
                            <span class=" float-right font-bold text-sm text-gray-400">{{$teaching->created_at->toFormattedDateString()}}</span>                             
                        </div>
                    </div>
                    @endforeach
                </div>
