                ...
                <article class="bg-gray-50 overflow-hidden shadow-xl sm:rounded-lg px-6 py-10">
                    <div class="px-6 py-4">
                        ...
                        <div class="flex p-4 mb-4 bg-green-100 rounded-lg dark:bg-green-200 " role="alert">
                            ...
                            <button type="button"
                                class="ml-auto -mx-1.5 -my-1.5 bg-red-100 text-red-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-green-200 dark:text-green-600 dark:hover:bg-green-300"
                                data-dismiss-target="#alert-3" aria-label="Close">
                                <span class="sr-only">Cerrar</span>
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                                    xmlns="http://www.w3.org/2000/svg">
