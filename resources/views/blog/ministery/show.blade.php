                ...
                <div class="flex flex-wrap items-center content-center">
                    ...
                    <div class="flex w-1/2 justify-end content-center">		
                        <p class="hidden sm:block mr-3 text-center h-14 p-4 text-xs"><span class="pr-2">Comparte esto</span> 👉</p>
                            <a class="inline-block text-white no-underline hover:text-white hover:text-underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4" href="https://twitter.com/intent/tweet?url={{route('blog.show_ministery',$ministery->slug)}}" style="background-color:#33b1ff;">
                            ...
                            <a class="inline-block text-white no-underline hover:text-white hover:text-underline text-center h-10 w-10 p-2 md:h-auto md:w-16 md:p-4" href="https://www.facebook.com/sharer/sharer.php?u={{route('blog.show_ministery',$ministery->slug)}}" style="background-color:#005e99">
            ...
            <div class="mx-0 sm:mx-6">
                ...
                <form action="#">
                    <div class="container font-sans bg-green-100 rounded p-4 md:p-24 text-center mx-auto">
                        ...
                        <h3 class="font-bold break-normal  text-gray-600 text-base md:text-xl">Se el primero en obtener informacion de todo lo relacionado a los ministerios de MDC</h3>
                ...
                <div class="flex w-full items-center font-sans p-8 md:p-24">
                    <img class="w-10 h-10 rounded-full mr-4" src="@if($ministery->image){{asset('storage/'.$ministery->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif" alt="Avatar of Author">
                    <div class="flex-1">
                        <p class="text-base font-bold md:text-xl lg:text-3xl leading-none">VER MAS MINISTERIOS</p>
                    ...
                    <div class="justify-end">
                        <a href="{{route('blog.ministery')}}" class="bg-transparent border border-gray-500 hover:border-green-500 text-xs text-gray-500 hover:text-green-500 font-bold py-2 px-4 rounded-full">Leer Mas</a>
                    </div>
                </div>
            </div>  
        </div>
                    ...
                    @foreach ($similares as $ministerio)
                        <div class="pt-4 grid-cols-2 shadow mt-5 text-sm relative max-w-64 border-0  rounded-lg break-words text-gray-800 flex flex-col" style="background-color:white;">
                            <div class="py-0 z-10 mx-6 -mt-8 rounded-lg relative">
                                <a href="{{route('blog.show_ministery',$ministerio->slug)}}" class="block bg-transparent leading-none m-0 p-0 z-20 relative"><!----> 
                                    <img class="rounded-lg shadow" src="@if($ministerio->image){{asset('storage/'.$ministerio->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif" alt="Card image cap">
                                </a> 
                            ...
                            <div class=" mt-0  px-6  flex flex-wrap items-baseline "> 
                                ...
                                <h4 class="mt-2  flex w-full text-lg leading-tight text-gray-700  hover:text-blue-800  font-bold font-serif ">
                                    <a href="{{route('blog.show_ministery',$ministerio->slug)}}">{{$ministerio->name}}</a>
                                </h4> 
                            ...
                            <div class="py-2 px-6 ">
                                <div class="flex-grow items-center  justify-between ">
                                    <h1 class="mb-3 text-gray-600 ">{{Illuminate\Support\Str::limit($ministerio->extract,120,'...')}}</h1>
                                </div>
                            </div>
                            <div class="lg:hidden px-6 pb-2">
                                <span class=" float-right font-bold text-sm text-gray-400">{{$ministerio->created_at->toFormattedDateString()}}</span>                             
                            </div>
                        </div>
                    @endforeach
                </div>
