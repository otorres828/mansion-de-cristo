...
@section('seo_redes_sociales')
    <meta property="og:description" content="{{ $testimony->name }}" />
@endsection
...
@section('main')
    <div class="bg-white font-sans leading-normal tracking-normal">
                ...
                <div class="flex flex-wrap items-center content-center">
                    ...
                    <div class="flex w-1/2 justify-end content-center">
                        <p class="hidden sm:block mr-3 text-center h-14 p-4 text-xs"><span class="pr-2">Comparte
                                ...
                                href="https://api.whatsapp.com/send/?text={{ route('blog.show_testimony', $testimony->slug) }}"
        ...
        <div class="hidden md:block container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded"
            style="background-image:url('@if ($testimony->image) {{imagenes_storage($testimony->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif'); height: 75vh;">
        </div>
        {{-- FOTO SM/MD --}}
        <div class="md:hidden mx-auto container px-2 lg:px-8  mt-4 bg-cover ">
            <img class="w-full h-96"
                src="@if ($testimony->image){{imagenes_storage($testimony->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif"
                alt="">

            {{-- <img class="w-full h-96"src="@if ($testimony->image){{imagenes_storage($testimony->image->url)}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif" alt=""> --}}
        </div>
        {{-- CUERPO --}}
