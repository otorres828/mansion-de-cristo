...
@section('main')
    <div class="bg-white font-sans leading-normal tracking-normal">
        ...
        <div class="hidden md:block container w-full max-w-6xl mx-auto bg-white bg-cover mt-8 rounded"
            style="background-image:url('@if ($testimony->image) {{ asset('storage/' . $testimony->image->url) }}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif'); height: 75vh;">
        </div>
        {{-- FOTO SM/MD --}}
