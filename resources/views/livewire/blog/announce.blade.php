        ...
        <div class="sticky top-10">
            ...
            @foreach ($similares as $similar)
                <article
                    ...
                    style="background-image: url(@if ($similar->image) https://mdc.nyc3.cdn.digitaloceanspaces.com/{{ $similar->image->url }}@else https://cdn.pixabay.com/photo/2022/01/26/05/56/stairs-6968125_960_720.jpg @endif)">
