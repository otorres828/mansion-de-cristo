<div class="relative ">
    ...
    <input class=" py-1 border-solid border-4 border-light-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md  w-full pl-10" wire:model="search" type="text" placeholder="Escribe el nombre del anuncio que buscas">
    ...
    @if($search!=null && $search!=' ' && $teachings->count())
        <div class="shadow-2xl w-full rounded px-3 py-3 pb-0 absolute z-20" style="background-color: white">
            @foreach($teachings as $teaching)
                <ul class=" max-h-screen  bottom-auto text-sm pb-2 scroll-auto" >
                    <li>
