                ...
                @foreach ($testimonies as $testimony)
                    <li class="swiper-slide p-2 ">
                        <div class="items-center p-6 bg-gray-200 rounded shadow-xl">
                            ...
                            --}}
                            <img class="w-20 h-20 object-cover rounded-full border-2 border-indigo-500"
                                    src="@if ($testimony->image)https://mdc.nyc3.cdn.digitaloceanspaces.com/{{$anuncio->image->url}}@else https://pbs.twimg.com/profile_images/740993726189834240/WbUqIPMS.jpg @endif">
