                    ...
                    <li class="swiper-slide p-2 ">
                        <article class="bg-white overflow-hidden sm:rounded-lg flex flex-col h-full hover:bg-slate-100">
                            <figure class="aspect-w-16 aspect-h-9">
                                <img class="object-cover object-center" src="{{ Storage::url($noticia->image->url) }}"
                            ...
                            <div class="px-6 pt-4 pb-5 flex-1 flex flex-col">
                                <h1 class="text-lg mb-1 leading-5">
                                    <a  class="text-bold"href="{{ route('blog.show_announces', $noticia) }}">{{ $noticia->name }}</a>
                                </h1>
                                <p class="text-sm mb-1 py-2 text-right">{{ $noticia->created_at->toFormattedDateString() }}</p>
