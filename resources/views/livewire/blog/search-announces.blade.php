<div class="relative ">
    ...
    <input class="py-2 border-solid border-1 border-light-blue-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md  w-full pl-10" wire:model="search" type="text" placeholder="Escribe una frase relacionada con la noticia que estas buscando">

    @if($search!=null && $search!=' ' && $announces->count())
