            ...
            @foreach ($ministries as $ministery)
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        <a class="btn btn-primary mr-1" href="{{ route('admin.blog.ministry.edit', $ministery) }}"><i
                                class="far fa-edit"></i></a>
                        <form class="destroy mr-1" action="{{ route('admin.blog.ministry.destroy', $ministery) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
