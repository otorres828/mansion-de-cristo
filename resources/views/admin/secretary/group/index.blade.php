                        ...
                        @foreach ($groups as $group)
                            <tr>
                                <td class="text-center">
                                    <form action="{{route('group.team',$group)}}" method="post">
                                        @csrf
                                        <button type="submit" style="text-decoration:none">{{$group->id}}</button>
                                    </form>
                                </td>
                                ...
                                <td class="d-flex">
                                    <a class="btn btn-primary mr-1" data-bs-toggle="modal" data-bs-target="#edit{{$group->id}}"><i class="far fa-edit"></i></a>
                            ...
                            <div class="modal fade" id="edit{{$group->id}}" tabindex="-1" aria-labelledby="edit{{$group->id}}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="card">
                                                <div class="card-body">
                                                    {!! Form::model($group,['route'=>['admin.secretary.group.update',$group],'autocomplete'=>'off','method'=>'put']) !!}
                                                        <div class="form-group">
                                                                {!! Form::hidden('temple_id', auth()->user()->temple_id) !!} 
                                                                {!! Form::label('name', 'NOMBRE DE LA RED',) !!}
                                                                {!! Form::text('name', $group->group->name, ['class'=>'form-control','placeholder'=>'Ingrese el nombre Red']) !!}           
                                                        </div>
                                                        <div class="d-flex justify-content-end align-items-baseline">
