                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::number('amount', null, ['class'=>'form-control','placeholder'=>'Ingrese la
                            cantidad']) !!}
                            @error('amount')
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('reference', null, ['class'=>'form-control','placeholder'=>'Ingrese la
                            referencia']) !!}
                            @error('amount')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="">@if ($finance->status==1) <button class="btn btn-danger">X</button> @else <button
                            class="btn btn-success"><i class="far fa-check-circle"></i></button> @endif</td>
