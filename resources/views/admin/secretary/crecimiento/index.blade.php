            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        <form class="destroy" action="{{route('crecimiento.destroy',$crecimiento)}}" method="POST">
                            @csrf
                            @method('delete')
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    {!!
                                    Form::model($crecimiento,['route'=>['crecimiento.update',$crecimiento],'autocomplete'=>'off','method'=>'put'])
                                    !!}
                                    <div class="form-group">
                                        {!! Form::label('name', 'Nombre del crecimiento') !!}
                                        {!! Form::text('name', $crecimiento->name ?? null,
                                        ['class' => 'form-control ','placeholder'=>'Ingrese el nombre del
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('status',
                                        $crecimiento->status == "inactivo" ? ['inactivo' =>"No",'activo' =>"Si"] :
                                        ['activo' =>"Si",'inactivo' =>"No"] , null,
                                        ['class' => 'form-control
                                        ','selected'=> true]) !!}
                                        @error('status')
                                        <span class="text-danger">{{ $message }}</span>
